...
<reference>
@J:/libbsa/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `J:/libbsa/.opencode/get-shit-done/references/user-profiling.md` to load:
