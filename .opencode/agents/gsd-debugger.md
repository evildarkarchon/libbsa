...
<required_reading>
@J:/libbsa/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@J:/libbsa/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = J:/libbsa/.opencode
                  → checks J:/libbsa/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = J:/libbsa/.opencode/get-shit-done
                  → writes to J:/libbsa/.opencode/get-shit-done/hooks/
...
@J:/libbsa/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @J:/libbsa/.opencode/get-shit-done/references/common-bug-patterns.md
