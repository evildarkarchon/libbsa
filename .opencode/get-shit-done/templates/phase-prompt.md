...
<!-- For checkpoint task examples and patterns, see @J:/libbsa/.opencode/get-shit-done/references/checkpoints.md -->
...
See `J:/libbsa/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `J:/libbsa/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `J:/libbsa/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
