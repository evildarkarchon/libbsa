...
```markdown
Read J:/libbsa/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: J:/libbsa/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read J:/libbsa/.opencode/agents/gsd-ui-checker.md for instructions.
