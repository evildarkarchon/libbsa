...
```
Agent(
  prompt="Read J:/libbsa/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `J:/libbsa/.opencode/get-shit-done/templates/SECURITY.md`
