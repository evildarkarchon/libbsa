...
```
Agent(
  prompt="Read J:/libbsa/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `J:/libbsa/.opencode/get-shit-done/templates/VALIDATION.md`
