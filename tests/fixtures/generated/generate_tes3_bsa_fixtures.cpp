...
std::string malformed_manifest() {
  ...
  "cases": [
    ...
    {"id": "tes3_stored_hash_mismatch", "archive": "tes3_stored_hash_mismatch.bsa", "expected_error": "format_error", "phase": "open"},
    {"id": "tes3_hash_collision", "archive": "tes3_hash_collision.bsa", "expected_error": "format_error", "phase": "open"},
