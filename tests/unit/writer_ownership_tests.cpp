...
TEST_CASE("BA2 GNRL writer move construction transfers staged entries", "[unit][writer_ownership]")
{
...
TEST_CASE("BA2 DX10 writer move assignment transfers snapshot-backed entries", "[unit][writer_ownership]")
{
