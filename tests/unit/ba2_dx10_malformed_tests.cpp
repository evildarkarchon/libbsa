...
namespace
{
  ...
  {
  public:
    /// Captures extracted bytes when malformed DX10 cases are expected to fail during extraction.
          ...
          "[unit][fixture][malformed][ba2_dx10_malformed]")
{
  ...
  for (const auto required : {"ba2_dx10_truncated_header",
                              "ba2_dx10_truncated_records",
                              "ba2_dx10_truncated_chunks",
                              "ba2_dx10_invalid_payload_span",
                              "ba2_dx10_inconsistent_chunk_sizes",
                              "ba2_dx10_bad_compressed_chunk",
                              "ba2_dx10_decoded_size_mismatch",
                              "ba2_dx10_mip_gap",
                              "ba2_dx10_duplicate_mip_face",
