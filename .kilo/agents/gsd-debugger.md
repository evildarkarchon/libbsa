...
<required_reading>
@J:/libbsa/.kilo/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@J:/libbsa/.kilo/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = J:/libbsa/.kilo
                  → checks J:/libbsa/.kilo/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = J:/libbsa/.kilo/get-shit-done
                  → writes to J:/libbsa/.kilo/get-shit-done/hooks/
...
@J:/libbsa/.kilo/get-shit-done/references/thinking-models-debug.md
...
- Read @J:/libbsa/.kilo/get-shit-done/references/common-bug-patterns.md
