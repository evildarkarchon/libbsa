...
<reference>
@J:/libbsa/.kilo/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `J:/libbsa/.kilo/get-shit-done/references/user-profiling.md` to load:
