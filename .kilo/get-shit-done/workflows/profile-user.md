...
Key references:
- @J:/libbsa/.kilo/get-shit-done/references/ui-brand.md (display patterns)
- @J:/libbsa/.kilo/agents/gsd-user-profiler.md (profiler agent definition)
- @J:/libbsa/.kilo/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="J:/libbsa/.kilo/get-shit-done/USER-PROFILE.md"
...
```bash
cp "J:/libbsa/.kilo/get-shit-done/USER-PROFILE.md" "J:/libbsa/.kilo/USER-PROFILE.backup.md"
```
...
✓ Stores profile at J:/libbsa/.kilo/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `J:/libbsa/.kilo/get-shit-done/references/user-profiling.md`
...
Reference: @J:/libbsa/.kilo/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to J:/libbsa/.kilo/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to J:/libbsa/.kilo/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at J:/libbsa/.kilo/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at J:/libbsa/.kilo/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to J:/libbsa/.kilo/AGENTS.md"
...
```bash
BACKUP_PATH="J:/libbsa/.kilo/USER-PROFILE.backup.md"
```
...
Your profile:    J:/libbsa/.kilo/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   J:/libbsa/.kilo/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        J:/libbsa/.kilo/AGENTS.md
```
