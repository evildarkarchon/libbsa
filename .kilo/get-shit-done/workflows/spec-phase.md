...
```bash
INIT=$(node "J:/libbsa/.kilo/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @J:/libbsa/.kilo/get-shit-done/templates/spec.md.
