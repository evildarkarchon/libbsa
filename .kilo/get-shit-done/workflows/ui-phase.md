...
```markdown
Read J:/libbsa/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: J:/libbsa/.kilo/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read J:/libbsa/.kilo/agents/gsd-ui-checker.md for instructions.
