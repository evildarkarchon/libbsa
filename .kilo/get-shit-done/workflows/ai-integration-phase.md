...
<required_reading>
@J:/libbsa/.kilo/get-shit-done/references/ai-frameworks.md
@J:/libbsa/.kilo/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read J:/libbsa/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "J:/libbsa/.kilo/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read J:/libbsa/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read J:/libbsa/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read J:/libbsa/.kilo/agents/gsd-eval-planner.md for instructions.
