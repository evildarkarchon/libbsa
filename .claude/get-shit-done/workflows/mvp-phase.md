...
<required_reading>
@J:/libbsa/.claude/get-shit-done/references/user-story-template.md
@J:/libbsa/.claude/get-shit-done/references/spidr-splitting.md
@J:/libbsa/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@J:/libbsa/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@J:/libbsa/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@J:/libbsa/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
