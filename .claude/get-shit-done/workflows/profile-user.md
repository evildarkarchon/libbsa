...
Key references:
- @J:/libbsa/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @J:/libbsa/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @J:/libbsa/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="J:/libbsa/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "J:/libbsa/.claude/get-shit-done/USER-PROFILE.md" "J:/libbsa/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at J:/libbsa/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `J:/libbsa/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @J:/libbsa/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to J:/libbsa/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to J:/libbsa/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at J:/libbsa/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at J:/libbsa/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to J:/libbsa/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="J:/libbsa/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    J:/libbsa/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   J:/libbsa/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        J:/libbsa/.claude/CLAUDE.md
```
