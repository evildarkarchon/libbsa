...
```markdown
Read J:/libbsa/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: J:/libbsa/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read J:/libbsa/.claude/agents/gsd-ui-checker.md for instructions.
