...
```bash
INIT=$(node "J:/libbsa/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @J:/libbsa/.claude/get-shit-done/templates/spec.md.
