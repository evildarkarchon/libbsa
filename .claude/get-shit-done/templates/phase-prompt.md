...
<!-- For checkpoint task examples and patterns, see @J:/libbsa/.claude/get-shit-done/references/checkpoints.md -->
...
See `J:/libbsa/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `J:/libbsa/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `J:/libbsa/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
