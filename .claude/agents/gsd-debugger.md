...
<required_reading>
@J:/libbsa/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@J:/libbsa/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = J:/libbsa/.claude
                  → checks J:/libbsa/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = J:/libbsa/.claude/get-shit-done
                  → writes to J:/libbsa/.claude/get-shit-done/hooks/
...
@J:/libbsa/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @J:/libbsa/.claude/get-shit-done/references/common-bug-patterns.md
