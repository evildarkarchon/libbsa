...
<reference>
@J:/libbsa/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `J:/libbsa/.claude/get-shit-done/references/user-profiling.md` to load:
