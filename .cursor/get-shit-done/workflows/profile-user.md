...
Key references:
- @J:/libbsa/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @J:/libbsa/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @J:/libbsa/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="J:/libbsa/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "J:/libbsa/.cursor/get-shit-done/USER-PROFILE.md" "J:/libbsa/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at J:/libbsa/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `J:/libbsa/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @J:/libbsa/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to J:/libbsa/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to J:/libbsa/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at J:/libbsa/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at J:/libbsa/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to J:/libbsa/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="J:/libbsa/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    J:/libbsa/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   J:/libbsa/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        J:/libbsa/.cursor/.cursor/rules/
```
