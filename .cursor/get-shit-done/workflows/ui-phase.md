...
```markdown
Read J:/libbsa/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: J:/libbsa/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read J:/libbsa/.cursor/agents/gsd-ui-checker.md for instructions.
