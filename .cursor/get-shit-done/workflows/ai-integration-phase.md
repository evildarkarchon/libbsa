...
<required_reading>
@J:/libbsa/.cursor/get-shit-done/references/ai-frameworks.md
@J:/libbsa/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read J:/libbsa/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "J:/libbsa/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read J:/libbsa/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read J:/libbsa/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read J:/libbsa/.cursor/agents/gsd-eval-planner.md for instructions.
