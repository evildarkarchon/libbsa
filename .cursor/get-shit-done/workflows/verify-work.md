...
<template>
@J:/libbsa/.cursor/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@J:/libbsa/.cursor/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `J:/libbsa/.cursor/get-shit-done/workflows/transition.md`.
...
- Follow @J:/libbsa/.cursor/get-shit-done/workflows/diagnose-issues.md
