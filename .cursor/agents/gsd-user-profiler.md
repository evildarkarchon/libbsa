...
<reference>
@J:/libbsa/.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `J:/libbsa/.cursor/get-shit-done/references/user-profiling.md` to load:
