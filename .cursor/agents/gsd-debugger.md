...
<required_reading>
@J:/libbsa/.cursor/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@J:/libbsa/.cursor/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = J:/libbsa/.cursor
                  → checks J:/libbsa/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = J:/libbsa/.cursor/get-shit-done
                  → writes to J:/libbsa/.cursor/get-shit-done/hooks/
...
@J:/libbsa/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @J:/libbsa/.cursor/get-shit-done/references/common-bug-patterns.md
