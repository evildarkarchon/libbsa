...
/// Decompresses a raw DEFLATE payload and requires exactly `expected_size`
/// bytes.
///
/// Malformed data or mismatched output size returns `format_error`, matching
/// the archive metadata validation later format parsers need.
