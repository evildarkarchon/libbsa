...
/// Builds a BA2 DX10 writer entry by loading, validating, and snapshotting DDS
/// source bytes. Snapshot files intentionally outlive the source path so
/// add_file owns later write input.
