...
namespace libbsa::formats::bsa
{
                                                                 ...
                                                                 std::uint32_t &file_flags)
  {
    ...
    for (auto &[canonical_folder, folder_group] : grouped)
    {
      ...
      std::sort(folder_entries.begin(), folder_entries.end(), [](const tes4_prepared_entry &lhs, const tes4_prepared_entry &rhs)
    ...
    std::sort(folders.begin(), folders.end(), [](const tes4_prepared_folder &lhs, const tes4_prepared_folder &rhs)
