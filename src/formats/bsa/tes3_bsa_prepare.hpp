...
namespace libbsa::formats::bsa
{
  ...
  /// Builds the internal writer entry used by public TES3 add_file/add_bytes calls.
  result<tes3_writer_entry> tes3_make_writer_entry(std::string_view archive_path);

  /// Validates a TES3 writer host path with the existing format-specific diagnostics.
  ...
  /// Prepares TES3 writer entries by sizing payloads, preserving serialized names, and sorting by TES3 hash order.
