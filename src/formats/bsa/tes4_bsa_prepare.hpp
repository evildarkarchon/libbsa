...
namespace libbsa::formats::bsa
{
  ...
  /// Builds the internal writer entry used by public TES4 BSA add_file/add_bytes calls.
  ...
  /// Returns whether the target and policy make new entries compressed by default.
  bool tes4_archive_default_compressed(tes4_bsa_target target, archive_compression_policy policy) noexcept;

  /// Returns whether file-name prefixes should be embedded in stored payloads for this target version.
  ...
  /// Prepares TES4 BSA folders by validating sources, routing compression, grouping, hashing, and sorting records.
