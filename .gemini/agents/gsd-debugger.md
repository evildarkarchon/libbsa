...
<required_reading>
@J:/libbsa/.gemini/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@J:/libbsa/.gemini/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = J:/libbsa/.gemini
                  → checks J:/libbsa/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = J:/libbsa/.gemini/get-shit-done
                  → writes to J:/libbsa/.gemini/get-shit-done/hooks/
...
@J:/libbsa/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @J:/libbsa/.gemini/get-shit-done/references/common-bug-patterns.md
