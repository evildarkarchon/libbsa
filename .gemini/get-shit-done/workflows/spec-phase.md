...
```bash
INIT=$(node "J:/libbsa/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @J:/libbsa/.gemini/get-shit-done/templates/spec.md.
