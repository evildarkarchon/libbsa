...
Key references:
- @J:/libbsa/.gemini/get-shit-done/references/ui-brand.md (display patterns)
- @J:/libbsa/.gemini/agents/gsd-user-profiler.md (profiler agent definition)
- @J:/libbsa/.gemini/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="J:/libbsa/.gemini/get-shit-done/USER-PROFILE.md"
...
```bash
cp "J:/libbsa/.gemini/get-shit-done/USER-PROFILE.md" "J:/libbsa/.gemini/USER-PROFILE.backup.md"
```
...
✓ Stores profile at J:/libbsa/.gemini/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `J:/libbsa/.gemini/get-shit-done/references/user-profiling.md`
...
Reference: @J:/libbsa/.gemini/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to J:/libbsa/.gemini/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to J:/libbsa/.gemini/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at J:/libbsa/.gemini/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at J:/libbsa/.gemini/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to J:/libbsa/.gemini/CLAUDE.md"
...
```bash
BACKUP_PATH="J:/libbsa/.gemini/USER-PROFILE.backup.md"
```
...
Your profile:    J:/libbsa/.gemini/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   J:/libbsa/.gemini/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        J:/libbsa/.gemini/CLAUDE.md
```
