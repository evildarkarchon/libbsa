...
```markdown
Read J:/libbsa/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: J:/libbsa/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read J:/libbsa/.gemini/agents/gsd-ui-checker.md for instructions.
