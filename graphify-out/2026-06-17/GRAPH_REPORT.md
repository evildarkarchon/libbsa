...
## Corpus Check
- 248 files · ~167,048 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3997 nodes · 8164 edges · 239 communities (220 shown, 19 thin omitted)
...
- `libbsa target` --references--> `libbsa_library_sources`  [EXTRACTED]
  D:/repos/libbsa/CMakeLists.txt → tests/CMakeLists.txt
- `tests subdirectory inclusion` --references--> `libbsa_tests`  [INFERRED]
  D:/repos/libbsa/CMakeLists.txt → tests/CMakeLists.txt
- `Generated Fixture Constant Reuse` --references--> `generate_tes4_bsa_fixtures_tool`  [INFERRED]
  D:/repos/libbsa/openspec/specs/format-compatibility-constants/spec.md → tests/CMakeLists.txt
- `Committed Generated Fixtures` --references--> `generate_tes3_bsa_fixtures`  [EXTRACTED]
  D:/repos/libbsa/tests/fixtures/README.md → tests/CMakeLists.txt
- `benchmark_sink_factory` --inherits--> `bulk_extract_sink_factory`  [EXTRACTED]
  benchmarks/libbsa_benchmarks.cpp → src/archive.cpp
...
- **MSVC ASan Instrumentation Flow** — cmakelists_libbsa_enable_msvc_asan_option, cmakelists_libbsa_enable_msvc_asan, cmakelists_libbsa_copy_msvc_asan_runtime_dlls, cmakelists_libbsa, cmakelists_bsa, tests_cmakelists_libbsa_link_internal_test_support [EXTRACTED 1.00]
...
Cohesion: 0.05
Nodes (82): append_snapshot_bytes(), ba2_dx10_assemble_chunk(), ba2_dx10_assemble_planned_entry(), ba2_dx10_chunk_snapshot_batch, aggregate_size, snapshots, checked_size_t(), checked_u16() (+74 more)
...
Cohesion: 0.06
Nodes (55): add_fits_u64(), ba2_dx10_assign_payload_offsets(), dedupe_key, compression, packed_size, raw_size, stored_payload, payload_assignment (+47 more)
...
Cohesion: 0.21
Nodes (28): archive_type_name(), archive_variant_name(), compression_name(), dispatch(), escaped_cli_text(), find_format(), find_option_spec(), has_flag() (+20 more)
...
Cohesion: 0.10
Nodes (22): discard_staged(), file_payload_sink, staged_, stream_, file_sink_factory, by_path_, mutex_, output_root_ (+14 more)
...
Cohesion: 0.26
Nodes (22): collect_input_files(), command_line_arguments(), error_code_name(), generic_utf8_path(), is_reparse_point(), is_within_root(), make_error(), make_staged_temp_path() (+14 more)
...
Cohesion: 0.10
Nodes (21): Archive-Internal Path Policy, Bethesda Archive Formats, BSArchPro Behavioral Reference, C++20 Public API Contract, Format Compatibility Validation, libbsa, libbsa result Error Model, Streaming I/O Model (+13 more)

### Community 66 - "BA2 Record Docs"
Cohesion: 0.11
Nodes (21): Codec Output Allocation Errors, BA2 DX10 Aggregate Payload Size Checks, BA2 DX10 Record Extension Validation, BA2 GNRL Filename Table Span Checks, BA2 GNRL Record Extension Validation, DX10 DDS Input Requirement, Bounded Sink Extraction, DX10 Chunk-Scoped Extraction (+13 more)
...
Cohesion: 0.23
Nodes (14): build_archive(), build_source_dds(), byte_buffer, bytes, bytes(), overwrite_u64(), record_table_size(), source_dds_valid_specs() (+6 more)
...
Cohesion: 0.19
Nodes (17): clear_delete_on_close(), commit_staged(), final_path_for_handle(), final_path_is_within_root(), handle_is_reparse_point(), is_separator(), mark_delete_on_close(), open_staged_destination() (+9 more)
...
Cohesion: 0.18
Nodes (17): ascii_iequals(), is_windows_reserved_device_name(), lower_ascii(), print_format_table(), print_info_usage(), print_list_usage(), print_pack_usage(), print_top_level_usage() (+9 more)
...
Cohesion: 0.30
Nodes (15): archive_policy_from(), input_file, archive_path, host_path, main(), pack_ba2_dx10(), pack_ba2_gnrl(), pack_tes3() (+7 more)
...
Cohesion: 0.15
Nodes (13): TES4 Folder Block Offset Validation, Behavior-Backed Policy Tests, Executable Policy Oracles, Malformed Inputs for Parser Policy, Advisory Local Evidence, compatibility_matrix.json, COV-GAP-002, Coverage Audit Matrix (+5 more)
...
Cohesion: 0.22
Nodes (11): parsed_arguments, help, options, positionals, version, parsed_option, name, value (+3 more)
...
Cohesion: 0.22
Nodes (9): Allocation Error Translation, Parser Allocation Failures Use Result Errors, Shared Parser Read Allocation Errors, Shared Parser String Allocation Errors, CLI Foundation, Library Error Diagnostics, Subcommand Dispatch, result Error Contract (+1 more)
...
Cohesion: 0.29
Nodes (7): Metadata Container Allocation Errors, Metadata Count Bounds, validate Subcommand, Validation API, example_validate_archive, COV-GAP-001 Closed, validate_archive Concurrency
...
Cohesion: 0.29
Nodes (7): Committed Generated Fixtures, Generated Fixture Manifest Contracts, TES3 Manifest Schema, TES4-Family Manifest Schema, Generated Fixture Policy Wording, generate_tes4_bsa_fixtures, generate_tes4_bsa_fixtures_tool
...
Cohesion: 0.33
Nodes (6): DirectXTex Internal Adapter Policy, DirectXTex GitHub Releases, LZ4 Frame and Raw Block Separation, Minimal Dependency Policy, Public API Boundary, Required Runtime Libraries
...
Cohesion: 0.33
Nodes (6): Behavioral Guidance Preservation, Documentation Policy Tests, Durable Behavior Wording, Planning Identifier Exclusion, Public Documentation Stability, Thread-Safety Stable Terms
...
## Knowledge Gaps
- **1235 isolated node(s):** `scenario`, `worker_count`, `elapsed_ms`, `bytes_processed`, `correctness_passed` (+1230 more)
...
- **Why does `unordered_set` connect `Parser Primitives Unit` to `BA2 Dx10 Builder`, `Parser Primitives Metadata`, `BSA TES4 Prepare`, `BSA TES3 Prepare`, `BA2 Parser Dx10`, `BA2 Parser Gnrl`, `BA2 Gnrl Prepare`, `BSA TES3 Parser`, `BSA TES4 Parser`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `fail()` connect `Package Consumer Parser` to `Warning Compatibility Unit`, `BA2 Dx10 Unit`, `Validation API Unit`, `TES3 BSA Unit`, `BA2 Gnrl Unit`, `TES3 BSA Unit`, `Hotspot Policy Unit`, `BA2 Dx10 Malformed`, `BSA TES4 Unit`, `Local Game Unit`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `read_file_bytes_at()` connect `Parser Primitives Metadata` to `BA2 Parser Dx10`, `Byte Allocation Append`, `BA2 Parser Gnrl`, `BSA TES3 Parser`, `BSA TES4 Parser`?**
