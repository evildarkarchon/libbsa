...
## Corpus Check
- 206 files · ~147,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3748 nodes · 8732 edges · 164 communities
...
- compatibility_matrix_tests.cpp
- tes3_writer_entry
- detected_bsa_format
- tes3_prepared_entry
...
- uncompressed_format_case
- GitHub Issue Tracker
- Optional Local Corpus Checks

## God Nodes (most connected - your core abstractions)
1. `result` - 408 edges
2. `entry_metadata` - 55 edges
3. `ba2_profile` - 55 edges
...
## Communities (164 total, 0 thin omitted)

### Community 0 - "ba2_dx10_writer_tests.cpp"
Cohesion: 0.06
Nodes (75): set, dds_source_analysis, dds_bytes, image_payload_bytes, metadata, subresources, dds_source_subresource, array_index (+67 more)
...
### Community 2 - "string"
Cohesion: 0.07
Nodes (22): string, vector, archive_path_key, value, string, span, string_view, payload_sink (+14 more)
...
### Community 17 - "tes3_prepare_entries"
Cohesion: 0.25
Nodes (13): checked_u32(), span, string, string_view, uint32_t, uint64_t, vector, disk_payload_size() (+5 more)
...
### Community 21 - "result"
Cohesion: 0.12
Nodes (16): error, code, message, error_code, string, T, result, storage_ (+8 more)
...
Cohesion: 0.17
Nodes (24): ba2_dx10_prepared_stage_entry(), ba2_dx10_stage_entry(), ba2_gnrl_memory_stage_entry(), bytes_from_text(), byte, finalization_workspace, pair, path (+16 more)
...
Cohesion: 0.16
Nodes (29): bytes_from_text(), collecting_sink, bytes_, byte, path, payload_sink, size_t, span (+21 more)
...
Cohesion: 0.10
Nodes (39): ba2_compressed_payload_method(), ba2_profile, ba2_profile::ba2_profile(), compressed_method_, compressed_payload_method, default_compression, header_size, is_dx10 (+31 more)
...
Cohesion: 0.09
Nodes (28): bytes_from_text(), byte, path, span, string, string_view, vector, is_reparse_point() (+20 more)
...
Cohesion: 0.16
Nodes (19): ba2_gnrl_writer::add_bytes(), ba2_gnrl_writer::add_file(), ba2_gnrl_writer::ba2_gnrl_writer(), ba2_gnrl_writer::state, entries, options, target, ba2_gnrl_writer::target() (+11 more)
...
### Community 55 - "ba2_dx10_write_archive_bytes"
Cohesion: 0.20
...
### Community 60 - "optional"
Cohesion: 0.10
Nodes (21): optional, compatibility_warning, archive_path, code, message, severity, compatibility_warning_code, compatibility_warning_severity (+13 more)
...
### Community 68 - "tes4_bsa_target"
Cohesion: 0.13
Nodes (22): tes4_bsa_target, byte, entry_compression_policy, span, string_view, tes4_bsa_writer, tes4_bsa_writer_options, uint32_t (+14 more)
...
Cohesion: 0.14
Nodes (12): archive_type, archive_variant, uint64_t, validation_options, expected_type, expected_variant, max_extractability_entry_bytes, validate_entry_extractability (+4 more)
...
Cohesion: 0.11
Nodes (20): archive_metadata, archive_flags, ba2, default_compression, file_count, type, variant, version (+12 more)

### Community 78 - "writer.hpp"
Cohesion: 0.10
Nodes (21): ba2_dx10_writer, ba2_dx10_target, ba2_dx10_writer, state_, ba2_gnrl_writer, ba2_gnrl_target, ba2_gnrl_writer, state_ (+13 more)

### Community 79 - "tes3_bsa_writer.cpp"
Cohesion: 0.17
Nodes (15): tes3_bsa_writer_options, overwrite_existing, tes3_validate_host_path(), byte, span, string_view, vector, tes3_bsa_writer::add_bytes() (+7 more)
...
### Community 81 - "tes4_bsa_parser.cpp"
Cohesion: 0.17
Nodes (18): byte, PayloadReader, size_t, span, uint64_t, vector, vector, materialize_entries() (+10 more)
...
### Community 83 - "serialization_expectation"
Cohesion: 0.15
Nodes (13): span, uint32_t, uint64_t, layout_expectation, folder_block_offset, payload_offset, target, read_stage_u32_le_at() (+5 more)
...
Cohesion: 0.10
Nodes (28): archive_default_compressed(), ba2_gnrl_make_writer_entry(), ba2_gnrl_prepare_entries(), ba2_gnrl_validate_entries(), checked_u32(), archive_compression_policy, ba2_gnrl_writer_options, entry_compression_policy (+20 more)
...
### Community 93 - "lz4_codec_tests.cpp"
Cohesion: 0.19
...
### Community 98 - "archive_reader_tests.cpp"
Cohesion: 0.13
Nodes (15): collecting_sink, bytes_, bulk_extract_sink_factory, byte, path, payload_sink, size_t, span (+7 more)

### Community 99 - "profile_expectation"
Cohesion: 0.10
Nodes (20): archive_policy_expectation, later_default, oblivion_default, policy, archive_compression_policy, compression_method, entry_compression, size_t (+12 more)
...
### Community 106 - "entry_metadata"
Cohesion: 0.08
Nodes (38): entry_metadata, archive_hash, compression, embedded_name_prefix_size, has_embedded_name, original_path, path, payload_offset (+30 more)
...
### Community 111 - "compatibility_matrix_tests.cpp"
Cohesion: 0.30
Nodes (11): compatibility_matrix_path(), json, path, string, string_view, generated_archive_dir(), manifest_has_case_id(), read_json_file() (+3 more)

### Community 112 - "tes3_writer_entry"
Cohesion: 0.20
Nodes (9): byte, string, vector, tes3_writer_entry, archive_path_canonical, archive_path_original, from_memory, host_path (+1 more)

### Community 113 - "detected_bsa_format"
Cohesion: 0.22
Nodes (8): byte, span, detect_bsa_format(), detected_bsa_format, variant, version, archive_variant, uint32_t

### Community 114 - "tes3_prepared_entry"
Cohesion: 0.14
...
Cohesion: 0.13
Nodes (15): ba2_dx10_writer_options, deduplicate_payloads, max_decoded_chunk_bytes, overwrite_existing, starfield_compression_method, starfield_unknown1, starfield_unknown2, ba2_gnrl_entry_options (+7 more)

### Community 134 - "final_path_is_within_root"
Cohesion: 0.27
...
### Community 139 - "parser_primitives_tests.cpp"
Cohesion: 0.31
...
Cohesion: 0.38
Nodes (4): size_t, uint32_t, non_empty_span_intersects_prefix(), tes4_bsa_stored_payload_size()
...
### Community 152 - "deflate_codec_tests.cpp"
Cohesion: 0.33
Nodes (5): byte, size_t, vector, deflate_vector(), impossible_byte_vector_size()

### Community 153 - "native_handle_guard"
Cohesion: 0.47
...
### Community 162 - "uncompressed_format_case"
Cohesion: 0.22
Nodes (9): uint32_t, expected_version(), target_expectation, file_flags, target, uncompressed_format_case, archive_path, dxgi_format (+1 more)
...
## Knowledge Gaps
- **781 isolated node(s):** `scenario`, `worker_count`, `elapsed_ms`, `bytes_processed`, `correctness_passed` (+776 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `result` connect `result` to `ba2_dx10_writer_tests.cpp`, `bulk_extraction_tests.cpp`, `string`, `dds_layout.cpp`, `libbsa_benchmarks.cpp`, `ba2_record_identity`, `package-consumer/main.cpp`, `archive_reader_dispatch_tests.cpp`, `host_path_correctness_boundary_tests.cpp`, `stored_payload.cpp`, `ba2_gnrl_reader_tests.cpp`, `tes3_bsa_reader_tests.cpp`, `tes3_bsa_writer_tests.cpp`, `tes3_prepare_entries`, `tes4_bsa_reader_tests.cpp`, `tes4_bsa_header_fields`, `host_file.cpp`, `tes3_bsa_parser.cpp`, `host_file_path`, `tes4_bsa_prepare.cpp`, `local_game_fixture_tests.cpp`, `binary_reader`, `ba2_archive_opening_tests.cpp`, `tes4_placement_plan`, `tes4_bsa_writer_tests.cpp`, `ba2_dx10_record`, `ba2_profile`, `tes4_plan_placements`, `payload_stream_tests.cpp`, `writer_publish_tests.cpp`, `tes4_bsa_profile`, `file_sink_factory`, `ba2_dx10_extraction_tests.cpp`, `ba2_gnrl_writer.cpp`, `cli/main.cpp`, `make_tes4_bsa_payload_descriptor`, `writer_publish.cpp`, `ba2_archive_header`, `ba2_dx10_chunk_assembler.cpp`, `validation.cpp`, `ba2_dx10_write_archive_bytes`, `ba2_dx10_writer::state`, `ba2_gnrl_placed_record`, `optional`, `ba2_dx10_writer_entry`, `string`, `path`, `materialize_entries`, `tes4_bsa_target`, `payload_stream.cpp`, `ba2_archive_source`, `validation_options`, `ba2_dx10_build_writer_entry_snapshot`, `archive_metadata`, `writer.hpp`, `tes3_bsa_writer.cpp`, `dedupe_key`, `tes4_bsa_parser.cpp`, `materialize_entries`, `make_byte_vector`, `ba2_gnrl_writer_entry`, `tes3_write_archive_bytes`, `recording_sink`, `lz4_codec_tests.cpp`, `decompress_deflate_exact`, `decompress_payload_exact_to_sink`, `parser_primitives.cpp`, `ba2_gnrl_plan_placements`, `archive_reader_tests.cpp`, `commit_staged`, `unordered_set`, `analyze_dds_source`, `writer_entry_compression`, `entry_metadata`, `detected_bsa_format`, `read_ba2_dx10_records`, `tes4_bsa_raw_table`, `normalize_archive_path`, `decompress_lz4_block_exact`, `opened_ba2_archive`, `collecting_sink`, `tes4_bsa_constants.hpp`, `checked_u32`, `.write`?**
  _High betweenness centrality (0.291) - this node is a cross-community bridge._
- **Why does `tes4_bsa_profile` connect `tes4_bsa_profile` to `string`, `profile_expectation`, `tes4_bsa_target`, `tes4_plan_placements`, `writer_entry_compression`, `tes4_bsa_parser_seam_tests.cpp`, `tes4_bsa_parser.cpp`, `make_tes4_bsa_payload_descriptor`, `tes4_bsa_raw_table`, `tes4_bsa_header_fields`, `writer_stage_tests.cpp`, `tes4_bsa_prepare.cpp`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `entry_metadata` connect `entry_metadata` to `bulk_extraction_tests.cpp`, `string`, `libbsa_benchmarks.cpp`, `package-consumer/main.cpp`, `ba2_dx10_reader_tests.cpp`, `archive_reader_dispatch_tests.cpp`, `host_path_correctness_boundary_tests.cpp`, `tes3_bsa_writer_tests.cpp`, `opened_ba2_archive`, `tes3_bsa_parser.cpp`, `host_file_path`, `local_game_fixture_tests.cpp`, `bulk_extract_entry_result`, `tes4_bsa_writer_tests.cpp`, `texture_metadata`, `validation.cpp`, `optional`, `string`, `materialize_entries`, `archive_metadata`, `tes4_bsa_parser.cpp`, `materialize_entries`, `archive_reader_tests.cpp`?**
