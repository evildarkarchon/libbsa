...
## Corpus Check
- 211 files · ~148,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3779 nodes · 8771 edges · 179 communities (178 shown, 1 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 169 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `58f6ac7d`
...
- fingerprint_collision_fixture
- require_dx10_profile
...
## Communities (179 total, 1 thin omitted)
...
### Community 2 - "string"
Cohesion: 0.07
Nodes (16): optional, string, vector, span, string_view, payload_sink, payload_sink, finalization_workspace (+8 more)
...
Cohesion: 0.22
Nodes (26): ba2_record_identity_source, ba2_record_path, canonical_path, display_path, ba2_subtype, error_code, pair, string (+18 more)
...
Cohesion: 0.10
Nodes (36): uint32_t, multiply_fits(), parse_tes4_bsa_archive_file(), byte, size_t, span, string, string_view (+28 more)
...
Cohesion: 0.25
Nodes (30): make_byte_vector(), checked_buffer_size(), byte, error, function, ifstream, path, size_t (+22 more)

### Community 25 - "tes3_bsa_parser.cpp"
Cohesion: 0.14
Nodes (34): add_fits(), size_t, span_fits(), byte, size_t, span, string, uint32_t (+26 more)

### Community 26 - "writer_stage_tests.cpp"
Cohesion: 0.19
Nodes (23): ba2_dx10_prepared_stage_entries(), ba2_dx10_stage_entry(), ba2_gnrl_memory_stage_entry(), bytes_from_text(), byte, finalization_workspace, pair, path (+15 more)

### Community 27 - "archive_reader::extract_entries"
Cohesion: 0.14
Nodes (23): bulk_extract_sink_factory(), archive_reader::contains(), archive_reader::extract(), archive_reader::extract_bytes(), archive_reader::extract_entries(), archive_reader::find(), extract, bulk_request_group (+15 more)
...
Cohesion: 0.11
Nodes (18): ba2_dx10_prepared_entry, archive_path_canonical, archive_path_original, chunk_count, chunks, cube_maps_raw, directory_hash, dxgi_format (+10 more)
...
### Community 36 - "byte"
Cohesion: 0.23
Nodes (14): bytes_from_text(), collecting_sink, bytes_, byte, payload_sink, size_t, span, uint64_t (+6 more)
...
Cohesion: 0.09
Nodes (41): ba2_compressed_payload_method(), ba2_profile, ba2_profile::ba2_profile(), compressed_method_, compressed_payload_method, default_compression, header_size, is_dx10 (+33 more)
...
Cohesion: 0.08
Nodes (28): archive_compression_policy, archive_variant, compression_method, entry_compression_policy, size_t, tes4_bsa_writer_options, tes4_folder_record_shape, uint64_t (+20 more)
...
Cohesion: 0.10
Nodes (21): size_t, uint32_t, entry_compression, PayloadReader, size_t, uint32_t, uint64_t, make_tes4_bsa_payload_descriptor() (+13 more)
...
### Community 53 - "ba2_dx10_assemble_chunk"
Cohesion: 0.23
...
Cohesion: 0.06
Nodes (41): ba2_gnrl_payload_placement, offset, payload, stored_size, ba2_gnrl_placed_record, archive_path_original, directory_hash, extension (+33 more)
...
### Community 65 - "read_generated_dds_as_format"
Cohesion: 0.20
Nodes (10): uint32_t, expected_version(), read_generated_dds_as_format(), target_expectation, file_flags, target, uncompressed_format_case, archive_path (+2 more)

### Community 66 - "materialize_entries"
Cohesion: 0.24
Nodes (15): compression_for(), entry_compression, span, string, uint32_t, uint64_t, vector, first_payload_offset_for() (+7 more)
...
### Community 73 - "tes4_bsa_profile.cpp"
Cohesion: 0.21
Nodes (17): profile_facts, entry_compression, string_view, uint32_t, extension_for_path(), extension_is(), is_dx9_bsa_texture_format(), is_sse_bsa_texture_format() (+9 more)
...
Cohesion: 0.15
Nodes (13): ba2_dx10_prepared_chunk, compression, end_mip, is_payload_representative, packed_size, payload, payload_offset, raw_size (+5 more)
...
Cohesion: 0.13
Nodes (16): add_fits_u64(), ba2_dx10_assign_payload_offsets(), compression_method, span, stored_payload, uint32_t, uint64_t, dedupe_key (+8 more)
...
Cohesion: 0.14
Nodes (25): span_fits_u64(), compression_for(), array, byte, entry_compression, span, string, uint32_t (+17 more)
...
Cohesion: 0.22
Nodes (13): add_fits_u64(), archive_string_from_bytes(), byte, ifstream, span, string, string_view, uint64_t (+5 more)
...
Cohesion: 0.21
Nodes (13): BA2 Archive Header, BA2 Profile, TES4 BSA Profile, Archive Family Writer Examples, BA2 DX10 Snapshot Lifecycle, BA2 DX10 Target Policies, BA2 GNRL Target Policies, Deflate Compression Route (+5 more)
...
Cohesion: 0.11
Nodes (23): add_fits_u64(), checked_add_u32(), checked_mul_u32(), checked_u32(), span, string_view, uint32_t, uint64_t (+15 more)
...
### Community 111 - "ba2_record_identity"
Cohesion: 0.18
Nodes (14): ba2_record_identity, canonical_path, directory_hash, display_path, extension, name_hash, ba2_stored_record_identity, directory_hash (+6 more)

### Community 112 - "serialization_expectation"
Cohesion: 0.14
Nodes (14): size_t, span, uint32_t, uint64_t, layout_expectation, folder_block_offset, payload_offset, target (+6 more)
...
Cohesion: 0.30
Nodes (14): path, string, string_view, generated_source_dir(), non_ascii_output_path(), non_ascii_source_dir(), output_path(), read_binary_file() (+6 more)

### Community 115 - "tes4_bsa_target"
Cohesion: 0.18
Nodes (13): tes4_bsa_target, tes4_bsa_writer, tes4_bsa_writer_options, vector, tes4_bsa_writer::state, entries, options, target (+5 more)
...
Cohesion: 0.33
Nodes (6): Archive Entry Catalog, BA2 Archive Opening, BA2 Record Identity, Stored Payload, Glossary Vocabulary Policy, Single-Context Domain Layout
...
### Community 153 - "host_file_context"
Cohesion: 0.25
...
### Community 176 - "extension_fourcc_matches"
Cohesion: 0.67
Nodes (4): ascii_lower_byte(), array, byte, extension_fourcc_matches()

### Community 177 - "fingerprint_collision_fixture"
Cohesion: 0.50
Nodes (4): fingerprint_collision_fixture, distinct_a, distinct_b, fnv1a_fingerprint_collision()

### Community 178 - "require_dx10_profile"
Cohesion: 0.67
Nodes (3): ba2_dx10_target, ba2_dx10_writer_options, require_dx10_profile()

## Knowledge Gaps
- **797 isolated node(s):** `scenario`, `worker_count`, `elapsed_ms`, `bytes_processed`, `correctness_passed` (+792 more)
...
- **Why does `result` connect `result` to `ba2_dx10_writer_tests.cpp`, `bulk_extraction_tests.cpp`, `string`, `dds_layout.cpp`, `libbsa_benchmarks.cpp`, `ba2_record_identity.cpp`, `package-consumer/main.cpp`, `archive_reader_dispatch_tests.cpp`, `host_path_correctness_boundary_tests.cpp`, `stored_payload.cpp`, `ba2_gnrl_reader_tests.cpp`, `tes3_bsa_reader_tests.cpp`, `tes3_bsa_writer_tests.cpp`, `tes4_bsa_reader_tests.cpp`, `ba2_archive_header`, `tes4_bsa_header_fields`, `make_byte_vector`, `tes3_bsa_parser.cpp`, `archive_reader::extract_entries`, `tes4_bsa_prepare.cpp`, `local_game_fixture_tests.cpp`, `binary_reader`, `ba2_archive_opening_tests.cpp`, `tes4_placement_plan`, `byte`, `ba2_dx10_record`, `ba2_profile`, `tes4_plan_placements`, `payload_stream_tests.cpp`, `writer_publish_tests.cpp`, `tes4_bsa_profile`, `file_sink_factory`, `ba2_dx10_extraction_tests.cpp`, `write_ba2_gnrl_archive`, `cli/main.cpp`, `make_tes4_bsa_payload_descriptor`, `writer_publish.cpp`, `ba2_dx10_write_archive_bytes`, `ba2_dx10_assemble_chunk`, `validation_report`, `ba2_dx10_writer::state`, `ba2_gnrl_placed_record`, `ba2_dx10_writer_entry`, `string`, `materialize_entries`, `payload_stream.cpp`, `ba2_archive_source`, `path`, `tes4_bsa_profile.cpp`, `host_file_path`, `dedupe_key`, `detected_bsa_format`, `ba2_gnrl_writer_entry`, `materialize_entries`, `decompress_lz4_frame_exact_to_sink`, `archive_metadata`, `tes3_write_archive_bytes`, `recording_sink`, `recording_sink`, `decompress_deflate_exact`, `decompress_payload_exact_to_sink`, `parser_primitives.cpp`, `ba2_gnrl_plan_placements`, `collecting_sink`, `tes3_writer_entry`, `commit_staged`, `unordered_set`, `analyze_dds_source`, `ba2_dx10_build_writer_entry_snapshot`, `tes3_prepared_entry`, `ba2_record_identity`, `entry_metadata`, `extract_file_payload`, `normalize_archive_path`, `decompress_lz4_block_exact`, `ba2_gnrl_entry_options`, `stable_host_file_session`, `ba2_dx10_subresource_snapshot`, `opened_ba2_archive`, `write_tes4_bsa_archive`, `.write`, `collecting_sink`, `read_ba2_dx10_names`, `payload_stream.hpp`?**
  _High betweenness centrality (0.308) - this node is a cross-community bridge._
- **Why does `tes4_bsa_profile` connect `tes4_bsa_profile` to `string`, `tes4_plan_placements`, `tes4_bsa_profile.cpp`, `tes4_bsa_parser_seam_tests.cpp`, `detected_bsa_format`, `make_tes4_bsa_payload_descriptor`, `tes4_bsa_header_fields`, `writer_stage_tests.cpp`, `tes4_bsa_prepare.cpp`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `entry_metadata` connect `entry_metadata` to `bulk_extraction_tests.cpp`, `string`, `libbsa_benchmarks.cpp`, `package-consumer/main.cpp`, `ba2_dx10_reader_tests.cpp`, `archive_reader_dispatch_tests.cpp`, `host_path_correctness_boundary_tests.cpp`, `tes3_bsa_writer_tests.cpp`, `opened_ba2_archive`, `tes3_bsa_parser.cpp`, `archive_reader::extract_entries`, `local_game_fixture_tests.cpp`, `bulk_extract_entry_result`, `texture_metadata`, `validation_report`, `string`, `materialize_entries`, `detected_bsa_format`, `materialize_entries`, `archive_metadata`, `collecting_sink`, `tes4_bsa_writer_tests.cpp`, `extract_file_payload`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
