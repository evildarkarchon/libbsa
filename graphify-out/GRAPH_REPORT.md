...
## Corpus Check
- 242 files · ~165,081 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4465 nodes · 8584 edges · 264 communities (245 shown, 19 thin omitted)
...
- [[_COMMUNITY_tes4 bsa prepare cpp|tes4 bsa prepare cpp]]
- [[_COMMUNITY_payload sink|payload sink]]
- [[_COMMUNITY_ba2 dx10 writer tests cpp|ba2 dx10 writer tests cpp]]
- [[_COMMUNITY_main cpp|main cpp]]
- [[_COMMUNITY_libbsa benchmarks cpp|libbsa benchmarks cpp]]
- [[_COMMUNITY_generate tes4 bsa fixtures cpp|generate tes4 bsa fixtures cpp]]
- [[_COMMUNITY_generate ba2 gnrl fixtures cpp|generate ba2 gnrl fixtures cpp]]
- [[_COMMUNITY_tes3 write archive bytes|tes3 write archive bytes]]
- [[_COMMUNITY_ba2 dx10 parser cpp|ba2 dx10 parser cpp]]
- [[_COMMUNITY_host path correctness boundary tests|host path correctness boundary tests]]
- [[_COMMUNITY_ba2 dx10 parser tests cpp|ba2 dx10 parser tests cpp]]
- [[_COMMUNITY_ba2 gnrl writer tests cpp|ba2 gnrl writer tests cpp]]
- [[_COMMUNITY_validation api tests cpp|validation api tests cpp]]
- [[_COMMUNITY_tes3 bsa writer tests cpp|tes3 bsa writer tests cpp]]
- [[_COMMUNITY_ba2 gnrl reader tests cpp|ba2 gnrl reader tests cpp]]
- [[_COMMUNITY_tes3 bsa reader tests cpp|tes3 bsa reader tests cpp]]
- [[_COMMUNITY_archive reader dispatch tests cpp|archive reader dispatch tests cpp]]
- [[_COMMUNITY_writer hpp|writer hpp]]
- [[_COMMUNITY_archive cpp|archive cpp]]
- [[_COMMUNITY_generate tes3 bsa fixtures cpp|generate tes3 bsa fixtures cpp]]
- [[_COMMUNITY_ba2 gnrl parser cpp|ba2 gnrl parser cpp]]
- [[_COMMUNITY_tes4 bsa reader tests cpp|tes4 bsa reader tests cpp]]
- [[_COMMUNITY_dds layout cpp|dds layout cpp]]
- [[_COMMUNITY_ba2 gnrl prepare cpp|ba2 gnrl prepare cpp]]
- [[_COMMUNITY_generate tes3 bsa writer fixtures|generate tes3 bsa writer fixtures]]
- [[_COMMUNITY_tes4 bsa writer tests cpp|tes4 bsa writer tests cpp]]
- [[_COMMUNITY_ba2 dx10 chunk assembler cpp|ba2 dx10 chunk assembler cpp]]
- [[_COMMUNITY_ba2 writer execution tests cpp|ba2 writer execution tests cpp]]
- [[_COMMUNITY_local game fixture tests cpp|local game fixture tests cpp]]
- [[_COMMUNITY_ba2 dx10 record|ba2 dx10 record]]
- [[_COMMUNITY_tes4 bsa layout cpp|tes4 bsa layout cpp]]
...
- [[_COMMUNITY_validation cpp|validation cpp]]
- [[_COMMUNITY_tes4 bsa raw table|tes4 bsa raw table]]
- [[_COMMUNITY_read tes4 bsa raw table|read tes4 bsa raw table]]
- [[_COMMUNITY_Complete Open Spec Workflow Cycle|Complete Open Spec Workflow Cycle]]
- [[_COMMUNITY_memory source|memory source]]
- [[_COMMUNITY_validation report|validation report]]
- [[_COMMUNITY_validation policy tests cpp|validation policy tests cpp]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_ba2 dx10 prepare cpp|ba2 dx10 prepare cpp]]
- [[_COMMUNITY_ba2 gnrl assign payload offsets|ba2 gnrl assign payload offsets]]
- [[_COMMUNITY_writer stage tests cpp|writer stage tests cpp]]
...
- [[_COMMUNITY_binary io cpp|binary io cpp]]
- [[_COMMUNITY_Target Format Guide|Target Format Guide]]
- [[_COMMUNITY_tes4 prepared entry|tes4 prepared entry]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_ba2 dx10 extraction tests cpp|ba2 dx10 extraction tests cpp]]
...
- [[_COMMUNITY_libbsa link internal test support|libbsa link internal test support]]
- [[_COMMUNITY_write ba2 gnrl archive|write ba2 gnrl archive]]
- [[_COMMUNITY_tes4 bsa reader cpp|tes4 bsa reader cpp]]
- [[_COMMUNITY_Requirement Explicit writer target selection|Requirement Explicit writer target selection]]
- [[_COMMUNITY_binary reader|binary reader]]
- [[_COMMUNITY_logical texture segment|logical texture segment]]
- [[_COMMUNITY_ba2 dx10 preparer seam tests|ba2 dx10 preparer seam tests]]
- [[_COMMUNITY_bsa writer execution tests cpp|bsa writer execution tests cpp]]
- [[_COMMUNITY_libbsa Public API|libbsa Public API]]
- [[_COMMUNITY_parse tes4 bsa archive impl|parse tes4 bsa archive impl]]
- [[_COMMUNITY_compatibility warning tests cpp|compatibility warning tests cpp]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_ba2 dx10 reader cpp|ba2 dx10 reader cpp]]
- [[_COMMUNITY_ba2 dx10 build writer entry|ba2 dx10 build writer entry]]
- [[_COMMUNITY_read payload bytes at|read payload bytes at]]
...
- [[_COMMUNITY_SKILL md|SKILL md]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_dedupe key|dedupe key]]
- [[_COMMUNITY_ba2 gnrl reader cpp|ba2 gnrl reader cpp]]
- [[_COMMUNITY_build archive|build archive]]
- [[_COMMUNITY_chunk spec|chunk spec]]
- [[_COMMUNITY_writer publish tests cpp|writer publish tests cpp]]
- [[_COMMUNITY_ba2 dx10 subresource snapshot|ba2 dx10 subresource snapshot]]
- [[_COMMUNITY_decompress lz4 frame exact to|decompress lz4 frame exact to]]
- [[_COMMUNITY_publish writer output|publish writer output]]
- [[_COMMUNITY_generate ba2 dx10 fixtures cpp|generate ba2 dx10 fixtures cpp]]
- [[_COMMUNITY_validate compatibility matrix|validate compatibility matrix]]
- [[_COMMUNITY_Requirement Unpack an archive to|Requirement Unpack an archive to]]
- [[_COMMUNITY_decompress payload exact to sink|decompress payload exact to sink]]
- [[_COMMUNITY_error Cluster|error Cluster]]
- [[_COMMUNITY_ba2 dx10 malformed tests cpp|ba2 dx10 malformed tests cpp]]
...
- [[_COMMUNITY_find tes3 bsa entry|find tes3 bsa entry]]
- [[_COMMUNITY_bethesda hash cpp|bethesda hash cpp]]
...
- [[_COMMUNITY_recording sink|recording sink]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_writer target policies|writer target policies]]
- [[_COMMUNITY_Requirement Validate an archive|Requirement Validate an archive]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
...
- [[_COMMUNITY_Validation API|Validation API]]
- [[_COMMUNITY_compatibility evidence md|compatibility evidence md]]
- [[_COMMUNITY_libbsa tests|libbsa tests]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_Writer Bounded Source Reads|Writer Bounded Source Reads]]
- [[_COMMUNITY_detected ba2 format|detected ba2 format]]
- [[_COMMUNITY_Requirement BA2 DX10 snapshot backed|Requirement BA2 DX10 snapshot backed]]
- [[_COMMUNITY_graphify Pipeline|graphify Pipeline]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_tes4 bsa parser seam tests|tes4 bsa parser seam tests]]
- [[_COMMUNITY_writer execution options tests cpp|writer execution options tests cpp]]
- [[_COMMUNITY_writer hotspot policy tests cpp|writer hotspot policy tests cpp]]
...
- [[_COMMUNITY_Snapshot Ownership Semantics|Snapshot Ownership Semantics]]
- [[_COMMUNITY_archive hpp|archive hpp]]
- [[_COMMUNITY_entry metadata|entry metadata]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_host file tests cpp|host file tests cpp]]
- [[_COMMUNITY_writer ownership tests cpp|writer ownership tests cpp]]
- [[_COMMUNITY_libbsa Cluster|libbsa Cluster]]
- [[_COMMUNITY_detected header|detected header]]
- [[_COMMUNITY_Public API Reality Check|Public API Reality Check]]
- [[_COMMUNITY_Requirement Duplicate results mirror first|Requirement Duplicate results mirror first]]
- [[_COMMUNITY_decompress lz4 block exact|decompress lz4 block exact]]
- [[_COMMUNITY_Shared Writer Publish Lifecycle|Shared Writer Publish Lifecycle]]
- [[_COMMUNITY_Requirements Cluster|Requirements Cluster]]
- [[_COMMUNITY_texture metadata|texture metadata]]
- [[_COMMUNITY_tes3 writer entry|tes3 writer entry]]
- [[_COMMUNITY_Query Path Explain Flows|Query Path Explain Flows]]
...
- [[_COMMUNITY_docs policy tests cpp|docs policy tests cpp]]
- [[_COMMUNITY_host file path tests cpp|host file path tests cpp]]
- [[_COMMUNITY_parser preparer seam policy tests|parser preparer seam policy tests]]
- [[_COMMUNITY_Required Runtime Libraries|Required Runtime Libraries]]
- [[_COMMUNITY_README Build Verification Lanes|README Build Verification Lanes]]
- [[_COMMUNITY_normalize archive path|normalize archive path]]
- [[_COMMUNITY_Shared Library Export Surface|Shared Library Export Surface]]
- [[_COMMUNITY_libbsa package consumer Target|libbsa package consumer Target]]
- [[_COMMUNITY_archive spec|archive spec]]
- [[_COMMUNITY_graphify Cluster|graphify Cluster]]
- [[_COMMUNITY_graphify reference extra exports benchmark|graphify reference extra exports benchmark]]
- [[_COMMUNITY_benchmark policy tests cpp|benchmark policy tests cpp]]
- [[_COMMUNITY_target format policy tests cpp|target format policy tests cpp]]
...
- [[_COMMUNITY_Incremental Detection|Incremental Detection]]
...
- [[_COMMUNITY_Bulk Extraction|Bulk Extraction]]
- [[_COMMUNITY_Public Documentation Stability|Public Documentation Stability]]
- [[_COMMUNITY_Build Test Toolchain|Build Test Toolchain]]
- [[_COMMUNITY_libbsa Cluster|libbsa Cluster]]
- [[_COMMUNITY_PERF 05 Benchmark Harness|PERF 05 Benchmark Harness]]
...
- [[_COMMUNITY_Semantic Subagent Prompt|Semantic Subagent Prompt]]
- [[_COMMUNITY_bulk extract entry result|bulk extract entry result]]
- [[_COMMUNITY_deflate codec tests cpp|deflate codec tests cpp]]
- [[_COMMUNITY_MCP Server Usage|MCP Server Usage]]
- [[_COMMUNITY_archive reader|archive reader]]
- [[_COMMUNITY_publish file without replace|publish file without replace]]
...
- [[_COMMUNITY_Step 3 Extract entities relationships|Step 3 Extract entities relationships]]
- [[_COMMUNITY_Change Artifact Generation|Change Artifact Generation]]
- [[_COMMUNITY_graphify reference add a URL|graphify reference add a URL]]
...
- [[_COMMUNITY_vcpkg json|vcpkg json]]
- [[_COMMUNITY_Delta Specs|Delta Specs]]
- [[_COMMUNITY_Verification Report|Verification Report]]
...
- [[_COMMUNITY_compression router hpp|compression router hpp]]
- [[_COMMUNITY_lz4 frame codec hpp|lz4 frame codec hpp]]
- [[_COMMUNITY_mainpage libbsa Public API|mainpage libbsa Public API]]
- [[_COMMUNITY_Falkor DB Export|Falkor DB Export]]
...
- `Reference Boundary` --semantically_similar_to--> `TES5Edit Read-Only Boundary`  [INFERRED] [semantically similar]
  README.md → AGENTS.md
- `Generated Fixture Policy Wording` --references--> `Committed generated fixtures`  [INFERRED]
  openspec/specs/public-documentation-stability/spec.md → tests/fixtures/README.md
...
### Community 11 - "ba2 dx10 parser tests cpp"
Cohesion: 0.10
...
### Community 21 - "ba2 gnrl parser cpp"
Cohesion: 0.12
...
### Community 25 - "generate tes3 bsa writer fixtures"
Cohesion: 0.14
...
### Community 32 - "ba2 dx10 prepared entry"
Cohesion: 0.07
...
### Community 35 - "tes4 bsa raw table"
Cohesion: 0.08
...
### Community 42 - "ba2 dx10 prepare cpp"
Cohesion: 0.15
...
### Community 43 - "ba2 gnrl assign payload offsets"
Cohesion: 0.15
...
### Community 44 - "writer stage tests cpp"
Cohesion: 0.15
...
### Community 47 - "binary io cpp"
Cohesion: 0.18
Nodes (26): bytes(), can_read(), position(), read_bytes(), read_u16_le(), read_u32_le(), read_u64_le(), read_u8() (+18 more)

### Community 48 - "Target Format Guide"
Cohesion: 0.13
Nodes (21): Codec Output Allocation Errors, BA2 DX10 Record Extension Validation, BA2 GNRL Filename Table Span Checks, BA2 GNRL Record Extension Validation, TES4 Folder Block Offset Validation, DX10 DDS Input Requirement, DX10 Chunk-Scoped Extraction, BA2 GNRL Support (+13 more)

### Community 49 - "tes4 prepared entry"
Cohesion: 0.10
...
### Community 50 - "Requirements Cluster"
Cohesion: 0.08
...
### Community 51 - "ba2 dx10 extraction tests cpp"
Cohesion: 0.16
Nodes (23): byte, json, path, result, size_t, span, string, string_view (+15 more)

### Community 52 - "ba2 gnrl prepared entry"
Cohesion: 0.09
...
### Community 59 - "tes4 bsa reader cpp"
Cohesion: 0.17
...
### Community 60 - "Requirement Explicit writer target selection"
Cohesion: 0.09
...
### Community 64 - "bsa writer execution tests cpp"
Cohesion: 0.21
Nodes (22): archive_reader, byte, pair, path, size_t, span, string, string_view (+14 more)

### Community 65 - "libbsa Public API"
Cohesion: 0.13
Nodes (17): Archive Writer Layering, Archive Byte Compatibility Preservation, Per-Family Writer Pipeline Decomposition, Extraction Output Path Safety, Archive-Internal Path Mapping, pack Subcommand, Archive Virtual Paths, BA2 DX10 One-Shot Writer Lifecycle (+9 more)

### Community 66 - "parse tes4 bsa archive impl"
Cohesion: 0.19
...
### Community 69 - "ba2 dx10 reader cpp"
Cohesion: 0.21
...
### Community 70 - "ba2 dx10 build writer entry"
Cohesion: 0.21
...
### Community 71 - "read payload bytes at"
Cohesion: 0.28
...
### Community 72 - "source dds spec"
Cohesion: 0.12
Nodes (21): compression_route_name(), json_escape(), manifest_for(), source_dds_spec, archive_path, array_size, depth, file (+13 more)

### Community 73 - "AGENTS md"
Cohesion: 0.18
Nodes (19): Alternatives Considered, CI / Toolchain Recommendation, CMake Project Layout Recommendation, Comments and Documentation, Constraints, Dependencies, graphify, Hard Boundary: TES5Edit Is Read-Only (+11 more)

### Community 74 - "Coverage Audit Matrix"
Cohesion: 0.10
Nodes (21): BA2 DX10 Aggregate Payload Size Checks, Behavior-Backed Policy Tests, Executable Policy Oracles, Malformed Inputs for Parser Policy, Advisory local evidence, BA2 DX10, BA2 DX10 Support, BA2 GNRL (+13 more)

### Community 75 - "Requirements Cluster"
Cohesion: 0.10
...
### Community 78 - "Requirements Cluster"
Cohesion: 0.10
...
### Community 79 - "Requirements Cluster"
Cohesion: 0.10
...
### Community 81 - "ba2 gnrl reader cpp"
Cohesion: 0.26
...
### Community 85 - "ba2 dx10 subresource snapshot"
Cohesion: 0.13
...
### Community 86 - "decompress lz4 frame exact to"
Cohesion: 0.18
...
### Community 87 - "publish writer output"
Cohesion: 0.29
...
Cohesion: 0.25
Nodes (17): bytes_per_block(), canonicalize(), checked_u32(), dds_mip_size(), extension_fourcc(), filename_stem(), hash_folder(), is_block_compressed() (+9 more)
...
### Community 90 - "Requirement Unpack an archive to"
Cohesion: 0.12
...
### Community 91 - "decompress payload exact to sink"
Cohesion: 0.26
...
### Community 102 - "libbsa Fixture Policy"
Cohesion: 0.15
Nodes (16): Benchmark and generated data policy, Benchmark and Generated Data Policy, BSArchPro-Derived Comparison Manifest, BSArchPro-derived comparison manifest schema, Compatibility evidence, Compatibility Evidence Catalog, CTest Label Taxonomy, Fixture Provenance Requirements (+8 more)

### Community 103 - "Committed generated fixtures"
Cohesion: 0.17
Nodes (16): Committed generated fixtures, Generated Fixture Manifest Contracts, TES3 manifest schema, TES4-family manifest schema, Archive Behavior Preservation, Generated Fixture Constant Reuse, generate_ba2_dx10_fixtures, generate_ba2_dx10_fixtures_tool (+8 more)

### Community 104 - "format case"
Cohesion: 0.15
Nodes (15): byte, size_t, texture_chunk_metadata, uint16_t, uint32_t, uint64_t, vector, chunk() (+7 more)

### Community 105 - "recording sink"
Cohesion: 0.21
Nodes (13): byte, path, result, size_t, span, vector, impossible_byte_vector_size(), lz4_vector() (+5 more)

### Community 106 - "Requirements Cluster"
Cohesion: 0.12
...
### Community 107 - "writer target policies"
Cohesion: 0.17
...
### Community 108 - "Requirement Validate an archive"
Cohesion: 0.13
...
### Community 109 - "Requirements Cluster"
Cohesion: 0.12
...
### Community 110 - "Thread Safety thread safety"
Cohesion: 0.13
...
### Community 111 - "generate malformed"
Cohesion: 0.27
...
### Community 112 - "Requirements Cluster"
Cohesion: 0.13
...
### Community 115 - "compatibility evidence md"
Cohesion: 0.22
...
### Community 116 - "libbsa tests"
Cohesion: 0.14
Nodes (14): LIBBSA_BUILD_TESTS, tests subdirectory inclusion, Allocation-Safe Archive Strings, Bounded Exact Parser File Reads, Checked Archive Arithmetic, Display Separator Normalization, Format-Owned Path Rules, Shared Parser Primitives (+6 more)

### Community 117 - "Requirements Cluster"
Cohesion: 0.14
...
### Community 118 - "Writer Bounded Source Reads"
Cohesion: 0.14
...
### Community 121 - "graphify Pipeline"
Cohesion: 0.17
Nodes (13): Cache and Merge Pipeline, Graphify Community Outputs, graphify Pipeline, Kilo-specific rules, Semantic Subagent Extraction, Structural AST Extraction, Wiki Export, Cross-Repo Graph Merge (+5 more)

### Community 122 - "Requirements Cluster"
Cohesion: 0.15
...
### Community 127 - "Requirements Cluster"
Cohesion: 0.17
...
### Community 128 - "tes4 writer entry"
Cohesion: 0.20
...
### Community 129 - "make byte vector"
Cohesion: 0.42
...
### Community 130 - "Snapshot Ownership Semantics"
Cohesion: 0.20
Nodes (12): BA2 DX10 Snapshot Read Efficiency, Snapshot-Backed Chunk Batched Assembly, Snapshot Overhead Benchmarks, Snapshot Ownership Semantics, Snapshot Size Mismatch Publication Guard, Writer-Owned DDS Snapshots, Existing Archive Behavior Stability, Snapshot Cleanup Ownership (+4 more)

### Community 131 - "archive hpp"
Cohesion: 0.18
Nodes (9): LIBBSA_API, shared_ptr, state, string, vector, archive_reader, state_, bulk_extract_request (+1 more)

### Community 132 - "entry metadata"
Cohesion: 0.17
...
### Community 133 - "Requirements Cluster"
Cohesion: 0.17
...
### Community 134 - "host file tests cpp"
Cohesion: 0.29
Nodes (11): byte, host_file_context, path, span, string_view, vector, bytes_from_text(), source_path() (+3 more)

### Community 135 - "writer ownership tests cpp"
Cohesion: 0.30
Nodes (11): archive_reader, byte, path, span, string_view, vector, bytes_from_text(), generated_source_dir() (+3 more)

### Community 136 - "libbsa Cluster"
Cohesion: 0.18
Nodes (10): BSArchPro Behavioral Reference, Format Compatibility Validation, TES5Edit Read-Only Boundary, libbsa Test Gate, Build, Command-Line Tool, libbsa, Platform Support (+2 more)

### Community 137 - "detected header"
Cohesion: 0.24
...
### Community 138 - "Public API Reality Check"
Cohesion: 0.18
...
### Community 139 - "Requirement Duplicate results mirror first"
Cohesion: 0.17
...
### Community 140 - "decompress lz4 block exact"
Cohesion: 0.38
Nodes (10): block_error(), checked_int_size(), compress_lz4_block(), decompress_lz4_block_exact(), byte, error, result, size_t (+2 more)

### Community 141 - "Shared Writer Publish Lifecycle"
Cohesion: 0.20
Nodes (11): Atomic Snapshot Directory Reservation, Hardened Snapshot Directory Names, Snapshot Temporary Directory Hardening, Best-Effort Publish Cleanup, No-Overwrite Publication, Overwrite Publication, Publish Filesystem Boundaries, Reparse-Point Refusal (+3 more)

### Community 142 - "Requirements Cluster"
Cohesion: 0.18
...
### Community 145 - "Query Path Explain Flows"
Cohesion: 0.20
Nodes (10): Claude graphify Rules, Existing Graph Fast Path, Query Path Explain Flows, MCP Server Export, Native CLAUDE.md Integration, BFS Query Flow, DFS Path Flow, Explain Flow (+2 more)

### Community 146 - "What You Must Do When"
Cohesion: 0.20
...
### Community 150 - "coverage audit matrix docs tests"
Cohesion: 0.36
...
### Community 151 - "docs policy tests cpp"
Cohesion: 0.38
...
### Community 152 - "host file path tests cpp"
Cohesion: 0.42
...
Cohesion: 0.31
Nodes (8): Windows-Only Support Policy, graphify, Project Scope, Supported Presets, TES5Edit Boundary, README Build Verification Lanes, Configure Build Test Steps, Windows MSVC CI Matrix

### Community 156 - "normalize archive path"
Cohesion: 0.33
Nodes (8): archive_path_key, invalid_path_error(), is_drive_rooted(), lower_ascii(), normalize_archive_path(), error, result, string_view

### Community 157 - "Shared Library Export Surface"
Cohesion: 0.25
Nodes (9): Explicit LIBBSA_API export policy, Explicit Public API Exports, Export Annotations Source Compatibility, LIBBSA_API Macro, Private Implementation Symbols, Representative Public Symbols, Shared Library Export Surface, WINDOWS_EXPORT_ALL_SYMBOLS Disabled (+1 more)

### Community 158 - "libbsa package consumer Target"
Cohesion: 0.25
...
### Community 169 - "Incremental Detection"
Cohesion: 0.25
Nodes (8): Folder Watcher, needs_update Flag, URL Ingest Flow, Post-Commit Graph Rebuild Hook, build_merge Pruning, Code-Only Update Short Circuit, Update Graph Diff, Incremental Detection

### Community 170 - "thread safety docs policy tests"
Cohesion: 0.39
Nodes (7): initializer_list, path, string, string_view, read_text_file(), require_all_tokens(), source_root()

### Community 171 - "bsa Command Line Tool"
Cohesion: 0.29
Nodes (7): Archive-Internal Path Policy, Bethesda Archive Formats, bsa CLI Target, bsa Command-Line Tool, bsa CLI Subcommands, Supported Format Tokens, Stable CLI Exit Codes

### Community 172 - "ba2 dx10 archive"
Cohesion: 0.33
Nodes (6): ba2_dx10_archive, entries, metadata, archive_metadata, entry_metadata, vector

### Community 173 - "ba2 gnrl archive"
Cohesion: 0.33
Nodes (6): ba2_gnrl_archive, entries, metadata, archive_metadata, entry_metadata, vector

### Community 174 - "tes3 bsa archive"
Cohesion: 0.33
Nodes (6): tes3_bsa_archive, entries, metadata, archive_metadata, entry_metadata, vector

### Community 175 - "tes4 bsa archive"
Cohesion: 0.33
Nodes (6): tes4_bsa_archive, entries, metadata, archive_metadata, entry_metadata, vector

### Community 176 - "Bulk Extraction"
Cohesion: 0.33
...
### Community 177 - "Public Documentation Stability"
Cohesion: 0.29
...
### Community 178 - "Build Test Toolchain"
Cohesion: 0.33
...
### Community 179 - "libbsa Cluster"
Cohesion: 0.40
Nodes (6): C++20 Public API Contract, libbsa, libbsa result Error Model, Streaming I/O Model, libbsa Library Target, CMake libbsa Project

### Community 180 - "PERF 05 Benchmark Harness"
Cohesion: 0.33
...
### Community 181 - "detect bsa format"
Cohesion: 0.33
Nodes (5): detect_bsa_format(), byte, detected_bsa_format, result, span

### Community 182 - "tes4 layout result"
Cohesion: 0.33
Nodes (5): tes4_layout_result, file_count, total_file_name_length, total_folder_name_length, uint32_t

### Community 183 - "run indexed work"
Cohesion: 0.33
Nodes (5): run_indexed_work(), function, result, size_t, uint32_t

### Community 184 - "Semantic Subagent Prompt"
Cohesion: 0.33
Nodes (6): Honesty Rules, Confidence Rubric, Frontmatter Propagation Rule, Hyperedge Extraction Rule, Deterministic Node ID Format, Semantic Subagent Prompt

### Community 185 - "bulk extract entry result"
Cohesion: 0.33
Nodes (5): error, bulk_extract_entry_result, entry, failure, path

### Community 186 - "deflate codec tests cpp"
Cohesion: 0.40
Nodes (5): byte, size_t, vector, deflate_vector(), impossible_byte_vector_size()

### Community 187 - "MCP Server Usage"
Cohesion: 0.40
Nodes (5): Context7 (`mcp__context7`), Exa (`mcp__exa`), MCP Server Usage, Ref (`mcp__ref`), Tool Choice

### Community 188 - "archive reader"
Cohesion: 0.12
Nodes (17): unpack Subcommand, info Subcommand, list Subcommand, Gated Dependency-Light Build Deliverable, Bounded Sink Extraction, extract_bytes Materialization Limits, archive_reader, extract_bytes (+9 more)

### Community 189 - "publish file without replace"
Cohesion: 0.70
Nodes (4): publish_file_without_replace(), replace_file_atomically(), path, result

### Community 190 - "resolve host file path"
Cohesion: 0.50
Nodes (4): resolve_host_file_path(), host_file_path, result, string_view

### Community 191 - "bounded memory policy tests cpp"
Cohesion: 0.60
Nodes (4): path, string, read_text_file(), source_root()

### Community 192 - "export surface policy tests cpp"
Cohesion: 0.60
Nodes (4): path, string, read_text_file(), source_root()
...
### Community 195 - "host file path"
Cohesion: 0.50
Nodes (3): host_file_path, resolved, path

### Community 196 - "Internal TES4 BSA Constants Header"
Cohesion: 0.67
...
### Community 197 - "Step 3 Extract entities relationships"
Cohesion: 0.50
Nodes (4): Part A - Structural extraction for code files, Part B - Semantic extraction (parallel subagents), Part C - Merge AST + semantic into final extraction, Step 3 - Extract entities and relationships

### Community 198 - "Change Artifact Generation"
Cohesion: 0.50
Nodes (4): spec-driven Schema, Apply-Ready Artifact Flow, Change Artifact Generation, OpenSpec Propose

### Community 199 - "graphify reference add a URL"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 200 - "graphify reference commit hook native"
Cohesion: 0.50
...
### Community 202 - "graphify reference incremental update cluster"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 203 - "vcpkg json"
Cohesion: 0.50
Nodes (3): dependencies, name, version-semver

### Community 204 - "Delta Specs"
Cohesion: 0.67
Nodes (3): Delta Specs, Intelligent Merging, OpenSpec Sync Specs

### Community 205 - "Verification Report"
Cohesion: 0.67
...
- **Why does `discard_payload_sink` connect `validation cpp` to `payload sink`?**
