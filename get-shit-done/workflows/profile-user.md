...
Key references:
- @J:/libbsa/get-shit-done/references/ui-brand.md (display patterns)
- @J:/libbsa/agents/gsd-user-profiler.md (profiler agent definition)
- @J:/libbsa/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="J:/libbsa/get-shit-done/USER-PROFILE.md"
...
```bash
cp "J:/libbsa/get-shit-done/USER-PROFILE.md" "J:/libbsa/USER-PROFILE.backup.md"
```
...
✓ Stores profile at J:/libbsa/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `J:/libbsa/get-shit-done/references/user-profiling.md`
...
Reference: @J:/libbsa/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to J:/libbsa/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .clinerules" -- "Add profile to J:/libbsa/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at J:/libbsa/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at J:/libbsa/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to J:/libbsa/.clinerules"
...
```bash
BACKUP_PATH="J:/libbsa/USER-PROFILE.backup.md"
```
...
Your profile:    J:/libbsa/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   J:/libbsa/skills/gsd-dev-preferences/SKILL.md
  ✓ .clinerules section       .clinerules
  ✓ Global .clinerules        J:/libbsa/.clinerules
```
