...
```markdown
Read J:/libbsa/agents/gsd-ui-researcher.md for instructions.
...
Template: J:/libbsa/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read J:/libbsa/agents/gsd-ui-checker.md for instructions.
