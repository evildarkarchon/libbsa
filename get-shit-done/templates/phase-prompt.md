...
<!-- For checkpoint task examples and patterns, see @J:/libbsa/get-shit-done/references/checkpoints.md -->
...
See `J:/libbsa/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `J:/libbsa/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `J:/libbsa/get-shit-done/workflows/verify-phase.md` for verification logic.
