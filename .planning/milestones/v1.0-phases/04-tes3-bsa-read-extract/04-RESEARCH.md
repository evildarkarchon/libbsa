...
| CMake | Minimum 4.0; local tool reports 4.3.2 | Build orchestration and target source registration | Existing project uses CMake target sources, install file sets, and CTest test presets. [VERIFIED: `CMakeLists.txt`; VERIFIED: `CMakePresets.json`; VERIFIED: `cmake --version`] |
