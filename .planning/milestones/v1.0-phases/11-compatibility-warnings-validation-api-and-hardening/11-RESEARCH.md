...
| CMake | Minimum 4.0; local 4.3.2 available | Build, presets, install/export, CTest orchestration | `CMakePresets.json` declares schema version 6 and CMake minimum 4.0; local CMake reports 4.3.2. [VERIFIED: CMakePresets.json; VERIFIED: cmake --version] |
