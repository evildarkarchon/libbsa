...
| CMake | 4.0 minimum; local tool 4.3.2 | Build, private dependency wiring, CTest orchestration | Repository already uses CMake presets and CTest; local `cmake --version` reports 4.3.2. [VERIFIED: CMakeLists.txt] [VERIFIED: CMakePresets.json] [VERIFIED: local command] |
