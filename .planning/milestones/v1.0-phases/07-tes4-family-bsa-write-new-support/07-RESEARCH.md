...
| CMake | Minimum 4.0; local tool reports 4.3.2 | Build, test, install file-set updates | Repository uses CMake presets and target file sets for public headers. [VERIFIED: `CMakeLists.txt`; `CMakePresets.json`; `cmake --version`] |
