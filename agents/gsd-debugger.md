...
<required_reading>
@J:/libbsa/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@J:/libbsa/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = J:/libbsa
                  → checks J:/libbsa/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = J:/libbsa/get-shit-done
                  → writes to J:/libbsa/get-shit-done/hooks/
...
@J:/libbsa/get-shit-done/references/thinking-models-debug.md
...
- Read @J:/libbsa/get-shit-done/references/common-bug-patterns.md
