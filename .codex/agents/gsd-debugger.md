...
<required_reading>
@J:/libbsa/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@J:/libbsa/.codex/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = J:/libbsa/.codex
                  → checks J:/libbsa/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = J:/libbsa/.codex/get-shit-done
                  → writes to J:/libbsa/.codex/get-shit-done/hooks/
...
@J:/libbsa/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @J:/libbsa/.codex/get-shit-done/references/common-bug-patterns.md
