...
```markdown
Read J:/libbsa/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: J:/libbsa/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read J:/libbsa/.codex/agents/gsd-ui-checker.md for instructions.
