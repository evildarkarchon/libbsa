...
Key references:
- @J:/libbsa/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @J:/libbsa/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @J:/libbsa/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="J:/libbsa/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "J:/libbsa/.codex/get-shit-done/USER-PROFILE.md" "J:/libbsa/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at J:/libbsa/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `J:/libbsa/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @J:/libbsa/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to J:/libbsa/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to J:/libbsa/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at J:/libbsa/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at J:/libbsa/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to J:/libbsa/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="J:/libbsa/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    J:/libbsa/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   J:/libbsa/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        J:/libbsa/.codex/AGENTS.md
```
