...
```bash
INIT=$(node "J:/libbsa/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @J:/libbsa/.codex/get-shit-done/templates/spec.md.
