...
Specify the command-line executable foundation for libbsa archive tooling, including subcommand routing, global help/version behavior, format selection taxonomy, diagnostics, exit codes, and the gated dependency-light build contract.
