...
Define memory bounds for compressed extraction paths so sink-based extraction avoids unnecessary decoded payload materialization while preserving exact decoded-size validation.
