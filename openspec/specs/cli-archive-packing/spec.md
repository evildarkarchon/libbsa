...
Specify CLI archive packing behavior for creating new archives from host directories, including explicit format-driven writer selection, archive path mapping, compression and overwrite handling, and BA2 DX10 DDS input requirements.
