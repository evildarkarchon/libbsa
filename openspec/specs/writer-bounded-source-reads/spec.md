...
Ensure archive writer paths read disk-backed sources through bounded, centralized helpers so large inputs do not trigger unbounded vector growth or duplicate whole-file materialization when it is not required.
