...
Specify the internal layering contract for archive writer families so source preparation, layout planning, serialization, and final publication remain independently owned and testable without changing emitted archive bytes.
