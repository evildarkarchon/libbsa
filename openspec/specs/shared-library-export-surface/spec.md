...
Ensure libbsa's Windows shared-library builds expose only the supported public API surface through explicit export annotations while keeping static builds and public-header source compatibility intact.
